...
const defaultTransactionColDefs = {
  filter: true,
  sortable: true
};
const transactionColDefs = () => [
  ...
  },
  {
    ...
    field: "accountType",
    minWidth: 120,
    valueFormatter: (params) => ACCOUNT_TYPE_MAP[params.value]
  },
  {
...
const TransactionGridByMonth = ({ month, year }) => {
  ...
  const colDefs = reactExports.useMemo(() => transactionColDefs(), []);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(GridBase, { defaultColDef: defaultTransactionColDefs, colDefs, rowData: transactions });
};
const FormSelectBase = ({ options, selected, onSelect, ariaLabel }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Form.Select, { value: selected, "aria-label": ariaLabel, onChange: handleChange, children: options.map(({ value, label }, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value, children: label }, `${value}${index}`)) });
};
const BaseModal = ({
  modalTitle,
  buttonText,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "primary", size: "lg", onClick: handleShow, children: buttonText }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal, { size: "lg", backdrop: "static", show, onHide: handleClose, keyboard: false, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Modal.Header, { closeButton: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Modal.Title, { children: modalTitle }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Modal.Body, { children }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal.Footer, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "primary", onClick: handlePrimaryAction, children: primaryButtonText })
      ] })
    ] })
  ] });
};
...
const parseCSVFileToTransaction = (csvFile) => new Promise((resolve, reject) => {
  Papa.parse(csvFile, {
    skipEmptyLines: true,
    complete: (results) => {
...
const UploadTransaction = () => {
  ...
  const handleFileSelection = reactExports.useCallback((event) => {
    const fileList = event.currentTarget.files;
    if (fileList.length > 0) {
      setSelectedFile(fileList.item(0));
    }
  }, []);
  const handleTransactionUpload = reactExports.useCallback(
    (close) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    BaseModal,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Form.Group, { controlId: "formFile", className: "mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Form.Label, { children: "Account type for transactions" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Form.Group, { controlId: "formFile", className: "mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Form.Label, { children: "Select CSV file" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Form.Control, { type: "file", accept: "text/csv", onChange: handleFileSelection })
        ] }) }) })
      ]
    }
  );
...
const Transactions = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { className: "mb-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { className: "d-grid", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UploadTransaction, {}) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { children: selectedYear && selectedMonth && /* @__PURE__ */ jsxRuntimeExports.jsx(TransactionGridByMonth, { month: selectedMonth, year: selectedYear }) }) })
  ] });
};
export {
